        ...
        <>
            ...
            <FullScreenCenter>
                <div className={`flex items-center ${language === 'fa' && ' space-x-reverse divide-x-reverse'} space-x-4 divide-x-2 mb-4 select-none`}>
                    <h4 className="text-xl text-gray-500 dark:text-gray-100">{Number('404').toLocaleString(language)}</h4>
                    <p className="text-gray-400 px-4">{t('errors.404')}</p>
                </div>
